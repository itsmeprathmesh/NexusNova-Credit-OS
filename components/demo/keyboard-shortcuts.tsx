...
export function KeyboardShortcutsModal() {
  ...
  const descriptions = [
    ...
    "Quick search (already works)",
    "Close modals / walkthrough",
  ];
          ...
          >
            ...
            <div className="space-y-1.5">
              {shortcuts.map((s, i) => (
                ...
                >
                  <span className="text-sm text-muted">{descriptions[i]}</span>
            ...
            <p className="mt-4 text-xs text-muted">
              Tip: Hold ⌘ (Mac) or Ctrl (Windows) for more shortcuts
            </p>
          </motion.div>
        </motion.div>
      )}
